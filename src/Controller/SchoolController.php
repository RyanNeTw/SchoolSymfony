...
class SchoolController extends AbstractController
{
    ...
    public function show(School $school, classroomRepository $classroomRepository, classroom $classroom ): Response
    {
        $classroomOfSchool = $classroomRepository->getClassrommOfSchool($school->getId());


        return $this->render('school/show.html.twig', [
            'school' => $school,
            'classroom' => $classroomOfSchool,
            'classroom' => $classroom
        ]);
    }
